// @build: 2026-07-01.18-00-00 | id: COMP-BOTTOMNAV-V7 | desc: Corrección: usa función global toggleLista() en lugar de VoluntarioState.toggleLista()
window.BottomNav = {
  _contenedor: null,
  _activa: null,
  ...
  init(config) {
    ...
    this._contenedor.innerHTML = secciones.map(s => {
      if (s.accion) {
        return '<button class="nav-item" data-section="' + s.id + '" onclick="toggleLista()">' +
