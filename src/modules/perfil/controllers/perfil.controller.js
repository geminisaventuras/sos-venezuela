// @build: 2026-06-28.03-30-00 | id: B30-PERFIL-CTRL-FIX | desc: Manejo de errores mejorado sin 500 para reglas de negocio
...
class PerfilController {
  ...
  async guardar(req, res, next) {
    try {
      const userId = req.user.sub;
      const datosValidados = perfilEsquema.parse(req.body);
